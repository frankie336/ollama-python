...
import json
from new_clients.assisants_api_life_cycle_test import OllamaClient, setup_user, setup_thread, setup_message, setup_assistant, retrieve_messages, process_stream
...
assistant_id = setup_assistant(client, assistant_name, assistant_model)
